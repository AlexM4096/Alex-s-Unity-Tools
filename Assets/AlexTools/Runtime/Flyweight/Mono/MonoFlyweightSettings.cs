...
namespace AlexTools.Flyweight
{
        ...
        where TSettings : MonoFlyweightSettings<TFlyweight, TSettings>
    {
        ...
        protected override void OnGet(TFlyweight flyweight) => flyweight.gameObject.Enable();
        protected override void OnRelease(TFlyweight flyweight) => flyweight.gameObject.Disable();
